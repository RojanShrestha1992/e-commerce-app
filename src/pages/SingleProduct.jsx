          ...
          <div className="max-w-6xl mx-auto md:px-6 grid grid-cols-2 gap-10">
            ...
            <div className="w-full ">
              <img
                ...
                className="rounded-wxl w-100 aspect-square object-cover"
              />
            </div>
            {/* pro details  */}
            <div className="flex flex-col gap-6">
              ...
              <div className="text-gray-700">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <input type="number"  min={1} placeholder="1" className="w-20 border-gray-300 border rounded-lg px-3 py-1 focus:outline-none focus:ring-2 focus:ring-red-500" />
                </div>
                <div className="flex gap-4 mt-4">

                <button onClick={()=>addToCart(singleProduct)} className="px-6 cursor-pointer flex gap-2 py-2 text-lg bg-red-500 text-white rounded-md items-center"><IoCartOutline className="w-6 h-6"/> Add to Cart</button>
                </div>
